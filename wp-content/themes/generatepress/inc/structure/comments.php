...
function generate_set_comment_form_defaults( $defaults ) {
	...
	$defaults['title_reply']          = apply_filters( 'generate_leave_comment', __( 'Để lại bình luận', 'generatepress' ) );
	$defaults['label_submit']         = apply_filters( 'generate_post_comment', __( 'Bình luận bài viết', 'generatepress' ) );
